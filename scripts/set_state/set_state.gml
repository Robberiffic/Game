...
if (face==0 || face==1 || face==7 ){
		...
		if ( face==1 )&&(noone==instance_place( x,  y - y_tap , Coll_Obj_Master )){
			ret2 = "UP"; 
		}
		// if you're not running into anything, and you're moving DOWNRIGHT...
		if ( face==7 )&&(noone==instance_place( x,  y + y_tap, Coll_Obj_Master )){
			ret2 = "DOWN"; 		
		}
		
		// check what you run into if you're just moving right
		inst = instance_place(	x + x_tap,  y, Coll_Obj_Master);
		if (tap_flag)||(inst==noone){
			...
			if (face==0){	
				...
				if (coll_test == "Coll_Obj_UL") && noone==instance_place( x,  y - y_tap, Coll_Obj_Master ){
						ret1 = "RIGHT";
						ret2 = "UP";
				}
				if (coll_test == "Coll_Obj_DL") && noone==instance_place( x ,  y + y_tap, Coll_Obj_Master){
						ret1 = "RIGHT";
						ret2 = "DOWN";
				}
			}
...
if (face==3 || face==4 || face==5 ){	
		...
		if (face==3 )&&(noone==instance_place( x,  y - y_tap , Coll_Obj_Master)){
			ret2 = "UP"; 		
		}
		if (face==5 )&&(noone==instance_place( x ,  y + y_tap , Coll_Obj_Master )){
			ret2 = "DOWN"; 			
		}	
		...
		if (inst==noone){
			...
			if (face == 4){	
				...
				if (coll_test == "Coll_Obj_UR") && noone==instance_place( x,  y - y_tap , Coll_Obj_Master ){
						ret1 = "LEFT";
						ret2 = "UP";
				}
				if (coll_test == "Coll_Obj_DR") && noone==instance_place( x ,  y + y_tap, Coll_Obj_Master){
						ret1 = "LEFT";
						ret2 = "DOWN";
				}
			}
...
inst = instance_place(	x,  y - y_tap, Coll_Obj_Master)
if (face==2){
	...
	if (inst==noone){
		...
		coll_test = object_get_name(inst.object_index);
		if (coll_test == "Coll_Obj_DR") && noone==instance_place( x + x_tap,  y, Coll_Obj_Master ){
				ret1 = "RIGHT";
				ret2 = "UP";
		}
		if (coll_test == "Coll_Obj_DL") && noone==instance_place( x - x_tap,  y, Coll_Obj_Master ){
				ret1 = "LEFT";
				ret2 = "UP";
		}
...
if (face==6){			
	...
	if (inst==noone){
		...
		coll_test = object_get_name(inst.object_index);
		if (coll_test == "Coll_Obj_UR") && noone==instance_place( x + x_tap,  y, Coll_Obj_Master ){
				ret1 = "RIGHT";
				ret2 = "DOWN";
		}
		if (coll_test == "Coll_Obj_UL") && noone==instance_place( x - x_tap,  y, Coll_Obj_Master ){
				ret1 = "LEFT";
				ret2 = "DOWN";
		}
